...
class ImageFormtwo(forms.ModelForm):
    class Meta:
        model = jobdatas
        fields = ['username_post','job_position','upload_date','job_timing','company_title','job_description','skill_1','skill_2','skill_3','skill_4','skill_5','job_city','job_Address','contact_number','email_id','website_link','gmaps_link']
